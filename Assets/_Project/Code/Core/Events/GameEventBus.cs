...
namespace GameCoreModule
{
    public class GameEventBus
    {
        ...
        public Action<PrefabID, Vector3> OnSpawnObjectFromPool 
        { get => _onSpawnObjectFromPool; set => _onSpawnObjectFromPool = value; }
        public Action<PrefabID, Vector3, Quaternion> OnSpawnRotatedObjectFromPool 
        { get => _onSpawnRotatedObjectFromPool; set => _onSpawnRotatedObjectFromPool = value; }
        public Action<PrefabID, Vector3, Transform> OnSpawnObject 
        { get => _onSpawnObject; set => _onSpawnObject = value; }
        public Action<PrefabID, Vector3> OnSpawnObjectWithoutRoot 
        { get => _onSpawnObjectWithoutRoot; set => _onSpawnObjectWithoutRoot = value; }
        public Action<PrefabID, Vector3, Quaternion, Transform> OnSpawnRotatedObject 
        ...
        { get => _onObjectSpawned; set => _onObjectSpawned = value; }
        public Action<GameObject, IPool> OnObjectSpawnedFromPool 
        { get => _onObjectSpawnedFromPool; set => _onObjectSpawnedFromPool = value; }
    }
}
